class ResultActivehuntListModel {
  final List<ResultActivehunt> resultActivehuntList;

  ResultActivehuntListModel({
    required this.resultActivehuntList,
  });

  factory ResultActivehuntListModel.fromJson(List<dynamic> json) => ResultActivehuntListModel(
    resultActivehuntList: List<ResultActivehunt>.from(json.map((x) => ResultActivehunt.fromJson(x))),
  );
}
