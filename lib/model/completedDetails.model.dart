...
class CompletedGameDetails {
  ...
  factory CompletedGameDetails.fromJson(Map<String, dynamic> json) => CompletedGameDetails(
        id: json["id"],
        gameId: json["game_id"],
        ...
        hostBy: json["host_by"],
        videoProcessed: json["videoProcessed"],
