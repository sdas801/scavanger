class ChallangeDetailsModel {
    ...
    factory ChallangeDetailsModel.fromJson(Map<String, dynamic> json) => ChallangeDetailsModel(
        id: json["id"],
        gameId: json["game_id"],
        ...
        items: List<HuntItem>.from(json["items"].map((x) => HuntItem.fromJson(x))),
        prizes: List<Prize>.from(json["prizes"].map((x) => Prize.fromJson(x))),
        isAllowToMsgOthers:  json["is_allow_to_msg_others"] == 1 || json["is_allow_to_msg_others"] == true,
    );
