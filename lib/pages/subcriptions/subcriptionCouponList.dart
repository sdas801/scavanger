...
class Subcriptioncouponlist extends StatefulWidget {
  final String name;
  final dynamic price;
  final dynamic subcription_id;
  final bool planType;

  const Subcriptioncouponlist({
    super.key,
    required this.name,
    required this.price,
  ...
  @override
  State<Subcriptioncouponlist> createState() => _SubcriptioncouponlistState();
}

class _SubcriptioncouponlistState extends State<Subcriptioncouponlist> {
