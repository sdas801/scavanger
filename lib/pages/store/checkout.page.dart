...
class CheckoutPage extends StatefulWidget {
  ...
  const CheckoutPage({super.key, required this.itemGroupDetails, this.coupon});
...
class _CheckoutPageState extends State<CheckoutPage> {
  ...
  void initState() {
    ...
    log("Group id for the item ${widget.itemGroupDetails.id}");
    if (widget.coupon != null) {
      ...
      totalPrice = widget.itemGroupDetails.price.toDouble();
    }
  }

  Future<void> initiateIntent() async {
    ApiService.paymentIntent({
      "itemGroupId": widget.itemGroupDetails.id,
      ...
      ApiService.addCoupon({"discount_code": coupon}).then((value) {
        ...
        if (value.success) {
          ...
          setState(() {
            ...
            if (discountedPrice1 >= widget.itemGroupDetails.price) {
              discountedPrice = 0;
              totalPrice = (widget.itemGroupDetails.price as num).toDouble();
              applyLoder = false;
              discount_id = 0;
              // isApplied = true;
              ...
              print("object============$discountedPrice1");
              discountedPrice = discountedPrice1;
              totalPrice = (widget.itemGroupDetails.price) - discountedPrice;
              applyLoder = false;
              isApplied = true;
              discount_id = discountData.discount_id;
            }
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          disabledBorder: const OutlineInputBorder(
                            ...
                            borderSide: BorderSide(
                                color: const Color.fromARGB(255, 12, 184, 41),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      SummaryRow(
                          label: 'Item (1)',
                          amount: '\$${widget.itemGroupDetails.price}'),
                      SummaryRow(
                          label: 'Discount',
